...
const controlClasses =
  'h-10 w-full rounded border border-border bg-background px-3 text-sm text-foreground placeholder:text-muted disabled:pointer-events-none disabled:opacity-50'
